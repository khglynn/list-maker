...
- **A7 → NEXT:** staleness alert — add a per-show "days since latest episode" check to `data_health.py` (write + test the logic; live Slack send needs `SLACK_WEBHOOK_URL` — note deferral).
