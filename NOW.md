...
```
Expected: one entity row (295, n8n, aliases now including NA10) and the mention pointing at 295 with review resolved. n8n's Notion page picks up the extra mention on the next daily sync. Next phase: 5 (Spotify-path tests) — a map is being written to `claude-plans/2026-09-04-phase-5/` for the morning.
