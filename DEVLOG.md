...
**Waiting on Kevin:** merge the arc to `main` (or "you can merge"), then say "run it" and I dispatch the Monday music run by hand so the TAL backlog drains today and the new alarm clears instead of paging for three evenings.
