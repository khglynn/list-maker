...
## Log
- 2026-09-02 18:45 — **Live.** Auto-ingest on (PR #38) after Kevin approved the labels; per-post Notion sync batched (PR #39: ~100 s → ~45 s a post); the first live run saved 49 posts (481 mentions, 389 entities, all mirrored), 30 skipped, 0 failed. Acceptance met: "How people are using ChatGPT" is in the Tech DB with its full text in Blog Posts, found by the judge, not by Kevin.
